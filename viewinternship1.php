...
<div class="row">
<div class="col-md-12">
<h4 class="text-center"><span class="glyphicon glyphicon-lock"></span> View Internships</h4>
</div>
<div class="col-sm-12 alert alert-success" >
<p class="text-center" ></p>
</div>
<div class="col-md-12">
<h4 class="text-center">Want To Add Internship,<a href="addinternship1.php">Click Here</a></h4>
</div>
<div class="col-md-12">
<?php
$obj=new functions();
